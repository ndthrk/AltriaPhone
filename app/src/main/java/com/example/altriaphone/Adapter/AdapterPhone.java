...
public class AdapterPhone extends RecyclerView.Adapter<AdapterPhone.ViewHolder> {
    ...
    public AdapterPhone(ArrayList<Product> items, Context context, int NUM_SHOW) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.size.setText(strSize);
        holder.rom.setText(item.getRom());
        holder.ram.setText(item.getRam());
        // Định dạng số và hiển thị trong TextView
